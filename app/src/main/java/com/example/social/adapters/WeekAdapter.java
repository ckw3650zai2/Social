...
public class WeekAdapter extends ArrayAdapter<Week> {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        week = new Week(subject, type, room, time_from, time_to, color);
        ...
        ImageViewCompat.setImageTintList(convertView.findViewById(R.id.typeimage), ColorStateList.valueOf(textColor));
        ...
        holder.subject.setBackgroundResource(outValue.resourceId);
