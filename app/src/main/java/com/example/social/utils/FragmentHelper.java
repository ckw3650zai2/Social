...
import com.example.social.adapters.WeekAdapter;
...
public class FragmentHelper {
    ...
    @NonNull
    public static AbsListView.MultiChoiceModeListener setupListViewMultiSelect(@NonNull final AppCompatActivity activity, @NonNull final ListView listView, @NonNull final WeekAdapter adapter, @NonNull final com.example.social.utils.DbHelper db) {
